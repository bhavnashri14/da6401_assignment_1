...
def parse_arguments():
    ...
    parser.add_argument('-o', '--optimizer', type=str,default='rmsprop',choices=['sgd','momentum','nag','rmsprop','adam','nadam'],help='Optimiser')
    parser.add_argument('-lr', '--learning_rate', type=float,default=0.001,help='Learning rate')
    parser.add_argument('-wd', '--weight_decay', type=float,default=0.0,help='L2 regularisation weight decay')
    parser.add_argument('-nhl', '--num_layers', type=int,default=3,help='Batch size')
    parser.add_argument('-sz', '--hidden_size', type=int,nargs='+',default=[256,128,64],help='Hidden Layer sizes')
    parser.add_argument('-a', '--activation', type=str,default='relu',choices=['sigmoid','tanh','relu'],help='Activation')
